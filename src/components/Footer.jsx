...
function Footer({ passedmode }) {
    return (
        <div className={`${passedmode ? "light" : "dark"}`}>
            <div
                className="absolute inset-x-0 bottom-0 border border-gray-200/80 py-3 flex gap-2 shadow-lg rounded-xl bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300 dark:bg-black/80 px-32"
            >
