...
function Footer({ passedmode }) {
    return (
        <div className={`${passedmode ? "light" : "dark"}`}>
            <div
                className="md:w-[50%] w-full mx-auto shadow-2xl border-2 flex items-center justify-around bg-white dark:bg-[#1F2937] rounded py-2 px-4 mb-2 fixed bottom-0 left-[50%] translate-x-[-50%] z-50 dark:text-white"
            >
